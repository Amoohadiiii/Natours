...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGFkaXBvdXJhbmlhbiIsImEiOiJja3NmdDZjY2UwMXVvMzFtYmZkd2N5bXY1In0.pYwcJQ6_3iwEyZDsdNvEIQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/hadipouranian/cksfuolw118l518qqax7m6uii',
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alert.showAlert)('error', _context.t0.response.updateData.message);
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51JQADyImqDMG2zMXVtvk2TsMZKBTupP2jWxBwffzM2dvH4t2GhvXsxlk2dGODhNk59rTa9W28ZSPWdaGqF6ByyBw00FYIt5xsW');
            _context.prev = 1;
            _context.next = 4;
